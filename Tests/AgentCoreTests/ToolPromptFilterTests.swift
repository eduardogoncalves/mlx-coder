...
final class ToolPromptFilterTests: XCTestCase {
    func testOrchestratorFilterOnlyExposesOrchestrationTools() {
        ...
        XCTAssertEqual(filter.selectedToolNames, ["task", "todo", "plan_file", "log_knowledge", "search_knowledge", "task_output"])
    ...
    func testOrchestratorAllowedToolNamesSetMatchesOrderedList() {
        ...
        XCTAssertEqual(AgentLoop.orchestratorAllowedToolNamesOrdered, ["task", "todo", "plan_file", "log_knowledge", "search_knowledge", "task_output"])
    }
}
