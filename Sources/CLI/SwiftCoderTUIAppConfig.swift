    ...
    public static func build(
        ...
        AppConfig(
            ...
            commands: [
                ...
                AppConfig.CommandConfig(name: "/vision", description: "Show vision-load status for this session"),
                AppConfig.CommandConfig(name: "/vison",  description: "Alias for /vision"),
