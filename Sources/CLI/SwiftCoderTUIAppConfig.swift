    ...
    public static func build(
        ...
        AppConfig(
            ...
            commands: [
                ...
                AppConfig.CommandConfig(name: "/vison",  description: "Show vision-load status for this session (/vision alias)"),
                AppConfig.CommandConfig(name: "/vision", description: "Alias for /vison"),
