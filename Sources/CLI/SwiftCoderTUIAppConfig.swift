    ...
    public static func build(
        ...
        AppConfig(
            ...
            commands: [
                ...
                AppConfig.CommandConfig(name: "/compact", description: "Compact conversation history now"),
                ...
                AppConfig.CommandConfig(name: "/planner <msg>",    description: "Dispatch the planner sub-agent directly (skips orchestrator reasoning)"),
                AppConfig.CommandConfig(name: "/executor <msg>",   description: "Dispatch the executor sub-agent directly"),
                AppConfig.CommandConfig(name: "/reviewer <msg>",   description: "Dispatch the reviewer sub-agent directly"),
                AppConfig.CommandConfig(name: "/filesystem <msg>", description: "Dispatch the filesystem sub-agent directly"),
                AppConfig.CommandConfig(name: "/terminal <msg>",   description: "Dispatch the terminal sub-agent directly"),
                AppConfig.CommandConfig(name: "/discovery <desc>", description: "Requirements still unclear — research→plan, then asks before implementing"),
                AppConfig.CommandConfig(name: "/feature <desc>", description: "Requirements already settled — research→plan→execute→review, no pause"),
                AppConfig.CommandConfig(name: "/fix <desc>", description: "Known bug — deterministic diagnose→fix→verify pipeline"),
                AppConfig.CommandConfig(name: "/workflow <name> <desc>", description: "Run any built-in workflow by name"),
                ...
                AppConfig.CommandConfig(name: "/model role", description: "Assign models to planner/executor/reviewer"),
