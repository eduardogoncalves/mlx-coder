...
- Hook lifecycle support with audit-backed hook events: `permissionRequested`, `preToolCall`, `postToolCall`, `historyCompressed`, `steeringInjected`, `followUpStarted`, and `contextTransformApplied`.
